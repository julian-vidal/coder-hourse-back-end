...
const {loggerProd} = require("./logger_config")
...
const server = app.listen(PORT, () => {
    ...
    loggerProd.info(`Server in ${NODE_ENV} mode is listening at port ${PORT}`)
    loggerProd.error(`Server in ${NODE_ENV} mode is listening at port ${PORT}`)
    loggerProd.warn(`Server in ${NODE_ENV} mode is listening at port ${PORT}`)
})
